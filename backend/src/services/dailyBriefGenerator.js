  ...
  "todayTasks": [
    {
      "girlId": "女生ID",
      "girlName": "女生名",
      "relationshipStage": "关系阶段(EXPLORATION/FLIRTING/ADVANCEMENT/CONFIRMATION/STABLE)",
      "relationshipStageLabel": "中文标签",
      "tensionScore": 热度评分,
  ...
  try {
    ...
    const girlsList = girls.map(g => {
      ...
      return {
        id: g.id,
        name: g.name,
        relationshipStage: g.relationshipStage || null,
        relationshipStageLabel: g.relationshipStage ? (STAGE_LABELS[g.relationshipStage] || g.relationshipStage) : null,
  ...
  girls.forEach(girl => {
    ...
    pendingActions.forEach(action => {
      todayTasks.push({
        girlId: girl.id,
        girlName: girl.name,
        relationshipStage: girl.relationshipStage || null,
        relationshipStageLabel: girl.relationshipStage ? (STAGE_LABELS[girl.relationshipStage] || girl.relationshipStage) : null,
    ...
    if (girl.relationshipStage === 'FLIRTING') {
      weekTasks.push({
        girlId: girl.id,
        girlName: girl.name,
        relationshipStage: girl.relationshipStage,
        targetStage: 'ADVANCEMENT',
        action: '推进关系，争取约出来见面',
        type: '约会'
      });
    }
