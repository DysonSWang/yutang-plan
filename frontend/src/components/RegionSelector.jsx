...
const REGION_DATA = {
  ...
  cities: {
    ...
    '440000': [
      ...
      { code: '442100', name: '潮州市' },
      { code: '442200', name: '揭阳市' },
      { code: '442300', name: '云浮市' },
    ],
    '500000': [
    ...
    '420000': [
      ...
      { code: '429000', name: '仙桃市' },
      { code: '429100', name: '潜江市' },
      { code: '429200', name: '天门市' },
      { code: '429400', name: '神农架林区' },
    ],
    '350000': [
...
const CITY_BY_PROVINCE = {
  '11': [{ code: '110101', name: '北京市' }],
  '12': [{ code: '120101', name: '天津市' }],
  '13': [
  ...
  '37': [
    ...
    { code: '371000', name: '威海市' }, { code: '371100', name: '日照市' }, { code: '371200', name: '临沂市' },
    { code: '371300', name: '德州市' }, { code: '371400', name: '聊城市' }, { code: '371500', name: '滨州市' },
    { code: '371600', name: '菏泽市' },
  ],
  '41': [
    ...
    { code: '411600', name: '周口市' }, { code: '411700', name: '驻马店市' },
  ],
  '42': [
    ...
    { code: '422800', name: '恩施土家族苗族自治州' }, { code: '429000', name: '仙桃市' }, { code: '429100', name: '潜江市' },
    { code: '429200', name: '天门市' }, { code: '429400', name: '神农架林区' },
  ],
  '43': [
  ...
  '44': [
    ...
    { code: '442100', name: '潮州市' }, { code: '442200', name: '揭阳市' }, { code: '442300', name: '云浮市' },
  ],
  '45': [
  ...
  '53': [
    ...
    { code: '532500', name: '红河哈尼族彝族自治州' }, { code: '532600', name: '文山壮族苗族自治州' },
    { code: '532800', name: '西双版纳傣族自治州' }, { code: '532900', name: '大理白族自治州' },
    { code: '533100', name: '德宏傣族景颇族自治州' }, { code: '533300', name: '怒江傈僳族自治州' },
    { code: '533400', name: '迪庆藏族自治州' },
  ],
  '54': [
    { code: '540100', name: '拉萨市' }, { code: '540200', name: '日喀则市' }, { code: '540300', name: '林芝市' },
    { code: '540400', name: '昌都市' }, { code: '540500', name: '山南市' }, { code: '540600', name: '那曲市' },
  ...
  '63': [
    ...
    { code: '632300', name: '黄南藏族自治州' }, { code: '632500', name: '海南藏族自治州' },
    { code: '632600', name: '果洛藏族自治州' }, { code: '632700', name: '玉树藏族自治州' },
  ...
  '71': [{ code: '710100', name: '台北市' }, { code: '710200', name: '高雄市' }, { code: '710300', name: '基隆市' }],
  '81': [{ code: '810100', name: '香港特别行政区' }],
  '82': [{ code: '820100', name: '澳门特别行政区' }],
};

/**
 * 省市区三级联动选择器
 * @param {string} value - 当前值，格式："省 市 区" 或 "省 市" 或 "省"
...
export default function RegionSelector({ value, onChange }) {
  ...
  const cities = useMemo(() => {
    if (!province) return [];
    const prov = REGION_DATA.provinces.find(p => p.name === province);
    if (!prov) return [];
    const prefix = prov.code.slice(0, 2);
    return CITY_BY_PROVINCE[prefix] || [];
  }, [province]);
  ...
  const handleCityChange = (e) => {
    ...
    setCity(c);
    setDistrict('');
    onChange(province && c ? `${province} ${c}` : province);
  };

  const handleDistrictChange = (e) => {
    const d = e.target.value;
    setDistrict(d);
    onChange(province && city && d ? `${province} ${city} ${d}` : province && city ? `${province} ${city}` : province);
  };
