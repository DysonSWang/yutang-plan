...
public class CapDownloader {
    ...
    public long download(Context context, DownloadOptions options) throws NotImplementedError {
        ...
        final DownloadManager.Request req = new DownloadManager.Request(options.url)
                ...
                // 改用 app 私有外部目录，不需要 WRITE_EXTERNAL_STORAGE 权限
                // 路径: /storage/emulated/0/Android/data/com.zhuiai.app/files/Download/
                .setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, options.filename);
